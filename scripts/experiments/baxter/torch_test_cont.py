...
def main(args):
    ...
    total_input_size = args.encoder_input_size + args.mlp_input_size - args.encoder_output_size
    model = End2EndMPNet(total_input_size, args.encoder_input_size, args.mlp_input_size, \
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_name', type=str, default='mlp_PReLU_ae_dd140.pkl')
